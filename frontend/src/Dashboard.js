...
import Tranctions from './components/Tranctions'
import { useDispatch } from 'react-redux';
import { TranctionGet } from './Redux/tranctionSlice';
...
function Dashboard() {
  ...
  <Tranctions/>
      ...
      <div className='tale'>
<button onClick={handledataclick}>click</button>
      </div>
